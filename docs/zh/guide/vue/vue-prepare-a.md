...
一路走来，已将现阶段主流 Java 的开发方式梳理的差不多了，并在实际开发中利用[**【敏捷开发方法论】**]（小步快跑、快速迭代、持续集成）思想，为我们实现快速开发，持续交付打下了良好的基础。但想要成为真正的“互联网 Java 全栈工程师”还有很长的一段路要走，其中“我大前端”是绕不开的一门必修课。本阶段课程的主要目的就是带领我 Java 后台程序员认识前端、了解前端、掌握前端，为实现成为“互联网 Java 全栈工程师”再向前迈进一步。
